...
class Face_Recognition_System_Teacher:
    def __init__(self, root):
        ...
        b1_1.place(x=450,y=320,width=220,height=40)
        ...
        b2.place(x=750,y=100,width=220,height=220)
        ...
        b2_1.place(x=750,y=320,width=220,height=40)
        ...
        # Train data Button
        img7=Image.open(r"D:\PROJECT\FACE RECOGNITION ATTENDANCE SYSTEM\College-Project\pictures-bg\attendance.png")
        img7=img7.resize((220,220))
        self.train_data_img=ImageTk.PhotoImage(img7)
        
        b5=Button(bg_img_lbl,image=self.train_data_img,command=self.attendance,cursor="hand2")
        b5.place(x=450,y=390,width=220,height=220)
        
        b5_1=Button(bg_img_lbl,text="Attendance",command=self.attendance,cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b5_1.place(x=450,y=610,width=220,height=40)
...
if __name__ == "__main__":
    root=Tk()
    obj=Face_Recognition_System_Teacher(root)
    root.mainloop()